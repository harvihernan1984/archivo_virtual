...
<table width="593" border="0" cellpadding="0" cellspacing="0"   id="tabla_opciones"   >
		 ...
		 <tr id="fila_op_titulo"  >
		  ...
		  <th width="133" >DOCUMENTOS CON ANEXOS</th>
			...
			<tbody>
		<?php 
		$sql="select nombre, (select count(*) from gd_documento where gd_empresa.codigo=empresa and gd_empresa.borrado='N' and gd_documento.borrado='N'  ".$filtro_tipo_doc.") as cantidad_doc ,
