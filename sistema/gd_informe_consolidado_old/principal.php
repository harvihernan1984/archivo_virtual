	...
	<div align="left" id="encabezad" >
		<div id="toolbar" class="datagrid-toolbar" style=" position:relative; ">
			...
			<select id="opcion_informe" name="opcion_informe" style="width:300px;" onchange="filtrar_reg()">
				...
				<option value="conxemp" >Informe Inventario consolidado</option>
				<option value="conxempafecha" >Informe Inventario consolidado a fecha</option>
				<option value="conxempentrefecha" >Informe Inventario consolidado entre fechas</option>
             </select>
