...
if($pasa==true){
	$campos=explode(",","codigo,gd_usuario,gd_empresa_act,documento,accion,dir,nombre_doc,referencia");
	$valores=explode(",",$codigo.",secion,secion,documento,E,".$dir.",".$nombre.",referencia");
	$sql="select * from ".f_genera_parametros("gd_reg_anexo_documento",$campos,$valores,8);
	//echo $sql;
