...
if($evento=='EDIT'){
	$codigo=$item;
	$sql="select * from sis_modulos where codigo='".$codigo."'  ";
	//echo $sql;
  ...
  <tr>
	  ...
	  <td colspan="3" align="left" >
	  	<select name="padre" id="padre" style="width:240px" size="1" >
			...
			<?php $sql="select codigo,sis_mi_acendencia(codigo) as nombre from sis_modulos where codigo<>'-1' and tipo='M' and codigo<>'".$codigo."' order by nombre";
			$res=pg_query($conn,$sql);
