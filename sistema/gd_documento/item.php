...
<span style='color:#000000; font-size:10px;'> ) son obligatorios.</span>	</td>
    <td  align="left">&nbsp;</td>
    <td  align="left">&nbsp;</td>
    </tr>
  <tr height="20" class="divdatos_form">
    <td  align="right"><span style='color:#FF0000; font-size:12px;'>*</span>Entidad Origen : </td>
    <td  align="left"><input type="text" name="origen" id="origen" class="txttextoma" maxlength="290"  value="<?php echo $origen; ?>" required="required"/></td>
    <td  align="left">&nbsp;</td>
    <td  align="left">&nbsp;</td>
  </tr>
  <tr height="20" class="divdatos_form">
    <td  align="right">Proceso Origen : </td>
    <td  align="left"><input type="text" name="proc_origen" id="proc_origen" class="txttextoma" maxlength="190"  value="<?php echo $proc_origen; ?>"/></td>
    <td  align="left">&nbsp;</td>
    <td  align="left">&nbsp;</td>
  </tr>
  <tr height="20">
    ...
    <td  align="left">
    <input type="text" disabled="disabled" name="codificacion" id="codificacion" maxlength="120" class="txttextoma" value="<?php echo $codificacion; ?>"/>
    </td>
    <td  align="left">&nbsp;</td>
    <td  align="left">&nbsp;</td>
  </tr>
 ...
 <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb_hclinica"   >
    	 <?php 
				...
				on  gd_val.dato_atr =gd_at.codigo where  gd_at.borrado='N' and gd_tp.codigo='".$tipo_doc."'  order by gd_at.orden;";
				$res=pg_query($conn,$sql);
				$fila=0;
				while ($reg=pg_fetch_array($res)) { $fila=$fila+1;?>
				  <tr height="20" style="color:#FF0000">
					...
					<?php  } //FIN TEXTO LARGO
					 ...
					 <input  type="text"id="fecha_val<?php echo $fila;?>" onpaste="return false" name="fecha_val<?php echo $fila;?>"  size="20" value="<?php echo $reg["dato_val"];?>" onblur="u_case(this.id)" />
					  <?php } // FIN TEXTO FECHA
					  if($reg["tipo_dato"]=='NU'){ //NUMERO ENTERO?>
					 <input  type="text"id="valor<?php echo $fila;?>" onpaste="return false" name="valor<?php echo $fila;?>"  size="20" value="<?php echo $reg["dato_val"];?>" onKeyPress="return soloInt(event)"  />
					  <?php } // FIN NUMERO ENTERO
					   if($reg["tipo_dato"]=='DE'){ //NUMERO DECIMAL?>
					 <input  type="text"id="valor<?php echo $fila;?>" onpaste="return false" name="valor<?php echo $fila;?>"  size="20" value="<?php echo $reg["dato_val"];?>" onKeyPress="return soloDec(event)"  />
...
<div id="div_anexo<?php echo $num_anexos;?>">
					<iframe  name="iframe" id="iframe" width="99%" frameborder="0" scrolling="no" style=" height:32px;border:none; overflow:hidden;" 
					src="<?php echo $directorio."/sistema/gd_documento/documento.php?
					empresa=".$_SESSION["gd_empresa_act"]."&documento=".$codigo_docu."&codigo=&error="; ?>" /></div>
<div id="tb_listado_anexos" class="divgrid">
	<table id="tb_anexos" border="0" cellpadding="0" cellspacing="0"    width="100%">
		...
		<tr>
				<td>
				<input  style="width:98%" name="referencia_doc<?php echo $a;?>" id="referencia_doc<?php echo $a;?>"  
				...
				<td>
				<a id="cmd_guardar_anexo" class="easyui-linkbutton l-btn l-btn-small l-btn-plain" 
				onclick="guardar_anexo_desc('<?php echo $a;?>')" plain="true" href="javascript:void(0)" >
				...
				<td>
				<a id="cmd_borrar-anexo" class="easyui-linkbutton l-btn l-btn-small l-btn-plain" onclick="borrar_anexo('<?php echo $a;?>')" plain="true" href="javascript:void(0)" >
					<span class="l-btn-left l-btn-icon-left">
					<span class="l-btn-text"></span>
					<span class="l-btn-icon cancel"> </span>
					</span>
				</a>
				</td>
		</tr>
