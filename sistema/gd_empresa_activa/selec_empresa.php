 ...
 <?php 
	...
	if($_GET["hijo"]=="periodo"){//llenamos sector?>
		<select name="area" id="area" style="width:400px" size="1">
			<option value="-1">-- Seleccione Area ---</option>
			<?php $sql="select codigo,nombre from atf_periodo where empresa='".$empresa."' order by nombre";
