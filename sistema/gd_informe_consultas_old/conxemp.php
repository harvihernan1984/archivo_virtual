...
<table width="593" border="0" cellpadding="0" cellspacing="0"   id="tabla_opciones"   >
		 ...
		 <tr id="fila_op_titulo"  >
		  ...
		  <th width="133" >CONSULTAS REALIZADAS</th>
			...
			<tbody>
		<?php 
		$sql="select nombre, (select count(*) from gd_registro_consultas where usuario in(select codigo from sis_usuario where empresa= gd_empresa.codigo )) as consultas 
