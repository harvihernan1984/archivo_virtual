...
<table width="593" border="0" cellpadding="0" cellspacing="0"   id="tabla_opciones"   >
		 ...
		 <tr id="fila_op_titulo"  >
		  ...
		  <tr id="fila_op_titulo"  >
		  <th colspan="2" style="background:none;"  align="center" ><em style="font-size:14px;">Hasta  el <?php echo $filtro_fecha; ?></em></th>
		  </tr>
		   <tr id="fila_op_titulo"  >
...
and cast(fecha_hora as date) <= cast('".$filtro_fecha."' as date)
) as consultas 
