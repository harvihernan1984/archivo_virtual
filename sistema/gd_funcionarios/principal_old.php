...
if(ValidaUsuario()==false){echo "<script type=''> mensage('Por favor inicie sesion');</script>"; return false;}
...
<input type='hidden' id='nombre_form' name='nombre_form' value='Personal'>
...
<div  id="frm" style="width: 555px; height: 350px;"> 
	...
	<table class='tableestilo'>
		...
		<td  width='36' align='right'>
		<a id="cmd_editar" href='javascript:void(0)' title='Editar' onClick="editar();">
		<div align="left" style="width:90px;height:32px;background:#EAEAEA;border-radius:5px; border:#AAAAAA solid;border-width:2px;" 
			onMouseOver="this.style.backgroundColor='#999999';" onMouseOut="this.style.backgroundColor='#EAEAEA';" >
		...
		<td  width='36' align='right'>
		<a id="cmd_buscar" href='javascript:void(0)' title='Buscar'	onClick="$('#orden').attr('value','persona');buscar('');">
		<div align="left" style="width:90px;height:32px;background:#EAEAEA;border-radius:5px; border:#AAAAAA solid;border-width:2px;"
			onMouseOver="this.style.backgroundColor='#999999';" onMouseOut="this.style.backgroundColor='#EAEAEA';" >
